...
<form name="form" method="POST" action= "<c:url value='/team/register' />"> 
        ...
        <div style="width: 100%; height: 100%; position: relative; background: white">
            ...
            <div style="left: 22px; top: 202px; position: absolute; color: #7D7C7C; font-size: 20px; font-family: Inter; font-weight: 100; word-wrap: break-word">�� ���� > �� ���</div>
      
          
            <input type = "button" style="left: 22px; top: 294px; position: absolute; color: #7D7C7C; font-size: 20px; font-family: Inter; font-weight: 900; word-wrap: break-word; border: 0; background-color: transparent " value = "�� ���" onClick = "location.href = 'teamManage_regi.jsp'">
            <input type = "button" style="left: 22px; top: 370px; position: absolute; color: #7D7C7C; font-size: 20px; font-family: Inter; font-weight: 400; word-wrap: break-word; border: 0; background-color: transparent " value = "��� ����" onClick = "location.href = 'teamManage_member.jsp'">
            <input type = "button" style="left: 22px; top: 446px; position: absolute; color: #7D7C7C; font-size: 20px; font-family: Inter; font-weight: 400; word-wrap: break-word; border: 0; background-color: transparent " value = "��� ���">
            <input type = "button" style="left: 22px; top: 524px; position: absolute; color: #7D7C7C; font-size: 20px; font-family: Inter; font-weight: 400; word-wrap: break-word; border: 0; background-color: transparent " value = "�� ���� ����">
           ...
           <!--����&���μ�-->
			...
			<!-- 
			<div style="left: 531px; top: 560px; position: absolute; color: #7D7C7C; font-size: 15px; font-family: Inter; font-weight: 100; word-wrap: break-word">�� ID</div>
            ...
            <div style="left: 531px; top: 603px; position: absolute; color: #7D7C7C; font-size: 15px; font-family: Inter; font-weight: 100; word-wrap: break-word">����</div>
            ...
            <div style="left: 499px; top: 704px; position: absolute; color: #7D7C7C; font-size: 15px; font-family: Inter; font-weight: 100; word-wrap: break-word">Ȱ�� ����</div>
            ...
            <div style="left: 531px; top: 652px; position: absolute; color: #7D7C7C; font-size: 15px; font-family: Inter; font-weight: 100; word-wrap: break-word">����</div>
            ...
            <div style=" left: 1086px; top: 764px; position: absolute">
                <input type = "submit" value = "����" class = "button" Onclick = "save()">
            </div>
