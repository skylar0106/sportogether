...
<body>
        ...
        <div style="width: 100%; height: 100%; position: relative; background: white">
            ...
            <div style="left: 22px; top: 202px; position: absolute; color: #7D7C7C; font-size: 20px; font-family: Inter; font-weight: 100; word-wrap: break-word">팀 관리 > 팀 정보 변경</div>
           ...
           <!--세로&가로선-->
            ...
            <div style="left: 531px; top: 450px; position: absolute; color: #7D7C7C; font-size: 15px; font-family: Inter; font-weight: 100; word-wrap: break-word">종목</div>
            <input type = "text" style="width: 406px; height: 23px; left: 570px; top: 450px; position: absolute; background: rgba(217, 217, 217, 0); border-radius: 10px; border: 1px #7D7C7C solid" name = "sport" value = "${team.sport}">           
            
            
            <div style="left: 499px; top: 500px; position: absolute; color: #7D7C7C; font-size: 15px; font-family: Inter; font-weight: 100; word-wrap: break-word">활동 지역</div>
            <input type = "text" style="width: 406px; height: 23px; left: 570px; top: 500px; position: absolute; background: rgba(217, 217, 217, 0); border-radius: 10px; border: 1px #7D7C7C solid" name = "location" value = "${team.location}">
