...
//                r.setDate(rs.getDate("date"));
    ...
    public int approveJoinRequestById(int teamId, String userId){
    	StringBuilder sql =  new StringBuilder();
    ...
    // 요청 거절 시 요청 목록에서 제거
    public boolean rejectRequest(int teamID, String userID) {
        return removeRequest(teamID, userID);
    }
    
    // 요청 목록에서 제거 id로
    private boolean removeRequest(int teamID, String userID) {
